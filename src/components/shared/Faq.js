				...
				<div className="faq__content">
					<div className="faq__questions">
						...
						>
							...
							<p>
								Modern AI technologies allow you to read the market with perfect
								accuracy and make profitable transactions, due to which Next
								technologies generate a percentage of income for partners.
							</p>
						</details>
						<details
							data-aos="fade-up"
							...
							data-aos-once="true"
						>
							<summary>Can I start investing with just $1?</summary>
							<p>
								Modern AI technologies allow you to read the market with perfect
								accuracy and make profitable transactions, due to which Next
								technologies generate a percentage of income for partners.
					...
					<div className="faq__feedback">
						<h3
							...
							data-aos-once="true"
						>
							Didn"t find the question you"re interested in?
						</h3>
						<p
